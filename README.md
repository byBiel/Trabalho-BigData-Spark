...
A base de dados utilizada no projeto deve ser obtida no portal oficial de dados do Ministério da Justiça e Segurança Pública:
...
```txt
1. Arquivos CSV baixados da base Consumidor.gov.br ficam em Spark-BigData/data/raw
...
- Os arquivos CSV de entrada devem ser baixados da base Consumidor.gov.br e colocados em `Spark-BigData/data/raw`.
